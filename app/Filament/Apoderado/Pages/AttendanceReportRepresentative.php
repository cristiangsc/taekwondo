...
class AttendanceReportRepresentative extends Page
{
    use Forms\Concerns\InteractsWithForms;

    protected static ?string $navigationIcon = 'heroicon-o-calendar-days';
    protected static string $view = 'filament.pages.attendance-report';
    protected static ?string $title = 'Asistencia Deportista';
    ...
    public function getAttendanceData()
    {
        ...
        $students = Student::query()->where('representative_id', auth()->user()->id)
