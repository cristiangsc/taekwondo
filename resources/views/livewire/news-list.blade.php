    ...
    <div class="bg-[#000E27] py-8">
        <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
            ...
            @if($latestNews)
                ...
                <div class="mb-12 bg-[#000E16] rounded-lg shadow-lg overflow-hidden">
                    <div class="md:flex">
                        <div class="md:w-1/2">
                            <img
                        ...
                        <div class="md:w-1/2 p-6 md:p-8 flex flex-col justify-between">
                            ...
                            <div class="mt-4">
                                ...
                                <a href="{{ route('news.show', $latestNews->slug) }}"
                                   class="inline-block bg-orange-600 hover:bg-orange-700 text-white font-semibold py-2 px-4 rounded">
                                    Leer más
                                </a>
                            </div>
                        </div>
