<section class="bg-[#EE5E10] py-12 relative z-0" id="contacto">
    <div class="max-w-7xl mx-auto px-4 sm:px-6 lg:px-8">
        <div class="text-center mb-8">
            ...
            <p class="mt-4 text-lg text-gray-200 max-w-2xl mx-auto">¿Tienes alguna pregunta o estás interesado en
                nuestras clases? Completa el formulario y nos pondremos en contacto contigo lo antes posible.</p>
        </div>
        ...
        <div class="max-w-3xl mx-auto">
            <div class="bg-[#000E27] rounded-xl shadow-lg overflow-hidden" x-data="{
                ...
                <div x-show="success" x-transition class="bg-green-50 p-6 mb-6 rounded-lg border border-green-200">
                    ...
                    <p class="mt-2 text-green-700">Gracias por contactarnos. Nos pondremos en contacto contigo lo antes
                        posible.</p>
                    <button @click="success = false"
                            class="mt-3 text-sm text-green-600 hover:text-green-800 font-medium">Enviar otro mensaje
                    </button>
                </div>
                ...
                <div x-show="error" x-transition class="bg-red-50 p-6 mb-6 rounded-lg border border-red-200">
                    ...
                    <p class="mt-2 text-red-700">Ha ocurrido un error al enviar tu mensaje. Por favor, inténtalo de
                        nuevo más tarde.</p>
                    <button @click="error = false" class="mt-3 text-sm text-red-600 hover:text-red-800 font-medium">
                        Cerrar
                    </button>
                </div>

                <!-- Contact Form -->
                <form wire:submit.prevent="submit" class="p-8 grid grid-cols-1 gap-y-6 sm:grid-cols-2 sm:gap-x-6">
                    <!-- Name Field -->
                    ...
                    <div class="sm:col-span-2">
                        <button type="submit"
                                ...
                                class="w-full inline-flex items-center justify-center px-6 py-3 border border-transparent
                            rounded-md shadow-sm text-base font-medium text-white cursor-pointer bg-[#EE5E10]
                            hover:bg-orange-400 focus:outline-none focus:ring-2 focus:ring-offset-2 focus:ring-blue-500
